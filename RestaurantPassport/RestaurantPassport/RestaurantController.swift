...
class RestaurantController {
    ...
    /*
     ...
     guard let identifier = restaurant.identifier,
     let representation = representationsByID[identifier] else { continue }
     
     restaurant.restaurantName = representation.restaurantName
     restaurant.identifier = representation.identifier?.uuidString
    ...
    /*
     ...
     guard let identifier = restaurant.identifier else {return}
    ...
    func createRestaurant(with restaurantName: String, myrating: Int16, stamped: Bool) {
        ...
        let restaurant = Restaurant(restaurantName: restaurantName, myRating: myrating, stamped: stamped)
